...
@section('content')
    ...
    <!--================Hero Banner start =================-->  
   @include('themes.partials.hero', ['title' => 'Register'])
    <!--================Hero Banner end =================-->  
   <!--================ Blog slider start =================-->  
    ...
    <div class="container">
      ...
      <div class="col-6">
              ...
              <div class="col-6">
                ...
                <div class="form-group">
                  <input class="form-control border" name="password_confirmation" id="password_confirmation" type="password" placeholder="Enter your password confirmation">
                  <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
                </div>
              </div>
            </div>
            <div class="form-group text-center text-md-right mt-3">
             <a href="/login" class="mx-3">Already have an account?</a>
